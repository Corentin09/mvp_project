...
class gramListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by gramParser#statesRew.
    def enterStatesRew(self, ctx:gramParser.StatesRewContext):
        pass

    # Exit a parse tree produced by gramParser#statesRew.
    def exitStatesRew(self, ctx:gramParser.StatesRewContext):
        pass


    # Enter a parse tree produced by gramParser#statesNoRew.
    def enterStatesNoRew(self, ctx:gramParser.StatesNoRewContext):
        pass

    # Exit a parse tree produced by gramParser#statesNoRew.
    def exitStatesNoRew(self, ctx:gramParser.StatesNoRewContext):
        pass
